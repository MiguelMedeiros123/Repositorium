...
view.funcionario_inserir("teste", "tester", dt.date(2000, 10, 10), 1234, "teste@email", 1000, dt.date(2020, 10, 10))

for x in view.funcionario_listar():
    print(x)

view.funcionario_excluir(1)

if view.funcionario_listar() == []:
    print("Excluído!")
